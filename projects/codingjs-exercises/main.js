...
function last2(str) {
    let count = 0;
    let clip = str.substring(str.length - 2);
    console.log('clip: ', clip);
    if ((str.indexOf(clip) !== str.length - 2) && (str.indexOf(clip))) {
        for (let i = 0; i < str.length - 2; i++) {
            console.log(str.indexOf(clip))
        }
        count++;
    }
    // return count;
}
// I tried, too tired. It's 4:37AM